...
public class HelloWorldController {
	...
	public String processFormVersionThree(@RequestParam("studentName") String theName, Model model) {//Assign theName to value of RequestParam
		
		/*
		// read the request parameter from the HTML form
		String theName = request.getParameter("studentName"); //Spring does this work behind the scenes
		*/
